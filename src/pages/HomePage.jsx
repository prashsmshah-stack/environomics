    ...
    <div className="scroll-smooth bg-white font-body text-on-surface selection:bg-primary/20">
      ...
      <div className="page-gradient-bottom">
        ...
        <section className="bg-transparent pb-16 pt-12 sm:pb-20 sm:pt-14 lg:pb-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 className="optika-bold mb-12 text-center text-3xl text-on-surface sm:mb-16 sm:text-4xl">YouTube Video Placeholders</h2>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              {videoPlaceholders.map((title) => (
                <div key={title} className="group aspect-video overflow-hidden rounded-xl border border-slate-200 bg-slate-100 shadow-sm transition-all hover:shadow-lg">
                  <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-slate-200 to-slate-300">
                    <div className="text-center">
                      <span className="material-symbols-outlined mb-3 block text-5xl text-slate-500">play_circle</span>
                      <p className="text-sm font-semibold text-slate-700">{title}</p>
                      <p className="mt-2 text-xs text-slate-500">Replace with your YouTube thumbnail or embed</p>
                    </div>
                  </div>
                </div>
              ))}
