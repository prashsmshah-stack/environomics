...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client logos shown on the Our Clients page';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaCards: Schema.Attribute.Component<'contact.cta-card', true>;
    heroSection: Schema.Attribute.Component<'contact.hero-section', false>;
    inquirySection: Schema.Attribute.Component<
    ...
    > &
      Schema.Attribute.Private;
    mapSection: Schema.Attribute.Component<'contact.map-section', false>;
    officeSection: Schema.Attribute.Component<'contact.office-section', false>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    brand: Schema.Attribute.Component<'footer.brand-section', false>;
    contactSection: Schema.Attribute.Component<'footer.contact-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickLinksSection: Schema.Attribute.Component<'footer.link-section', false>;
    servicesSection: Schema.Attribute.Component<'footer.link-section', false>;
    socialLinks: Schema.Attribute.Component<'common.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage hero, about, culture, video, and services content';
    displayName: 'Home';
  ...
  attributes: {
    aboutBody: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cultureTopics: Schema.Attribute.Component<'home.culture-topic', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videos: Schema.Attribute.Component<'home.video', true>;
  };
}
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    formName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Inquiry Form'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    projectSize: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project cards and case-study gallery content';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    projectSize: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client testimonial certificates shown on the Testimonials page';
  ...
  attributes: {
    ...
    displayOrder: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    filePageNumber: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
